...
namespace ManagerChannel.Migrations
{
    ...
    [Migration("20220110034057_update_regulation")]
    partial class update_regulation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Models.Authorization.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2022, 1, 10, 10, 40, 56, 814, DateTimeKind.Local).AddTicks(5187),
                            IsDeleted = false,
                        ...
                        new
                        {
                            ...
                            CreatedByUserId = "92ad4f43-4be7-4fb8-909f-ced532c58461",
                            CreatedDate = new DateTime(2022, 1, 10, 10, 40, 56, 814, DateTimeKind.Local).AddTicks(5649),
                            IsDeleted = false,
            ...
            modelBuilder.Entity("API.Models.Authorization.RolePermission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "d61ca5ad-a807-478c-aab4-8fdb07ba9e2d",
                            CreatedByUserId = "92ad4f43-4be7-4fb8-909f-ced532c58461",
                            CreatedDate = new DateTime(2022, 1, 10, 10, 40, 56, 814, DateTimeKind.Local).AddTicks(7638),
                            IsDeleted = false,
                            Permission = 0,
                        ...
                        new
                        {
                            Id = "2f9e8f4f-0530-4d95-b843-961e3782ce47",
                            CreatedByUserId = "92ad4f43-4be7-4fb8-909f-ced532c58461",
                            CreatedDate = new DateTime(2022, 1, 10, 10, 40, 56, 814, DateTimeKind.Local).AddTicks(8304),
                            IsDeleted = false,
                        ...
                        new
                        {
                            Id = "74b3b848-803a-4e09-b3fe-78241afe9467",
                            CreatedByUserId = "92ad4f43-4be7-4fb8-909f-ced532c58461",
                            CreatedDate = new DateTime(2022, 1, 10, 10, 40, 56, 814, DateTimeKind.Local).AddTicks(8313),
                            IsDeleted = false,
                        ...
                        new
                        {
                            Id = "0a04e44c-c64d-47bf-ab16-2d6f625391b3",
                            CreatedByUserId = "92ad4f43-4be7-4fb8-909f-ced532c58461",
                            CreatedDate = new DateTime(2022, 1, 10, 10, 40, 56, 814, DateTimeKind.Local).AddTicks(8318),
                            IsDeleted = false,
                        ...
                        new
                        {
                            Id = "b18bf050-4c73-4415-b5ac-2bd6cd9ee951",
                            CreatedByUserId = "92ad4f43-4be7-4fb8-909f-ced532c58461",
                            CreatedDate = new DateTime(2022, 1, 10, 10, 40, 56, 814, DateTimeKind.Local).AddTicks(8322),
                            IsDeleted = false,
                            Permission = 0,
            ...
            modelBuilder.Entity("API.Models.Authorization.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2022, 1, 10, 10, 40, 56, 813, DateTimeKind.Local).AddTicks(1504),
                            IsDeleted = false,
                            UserName = "admin"
                        });
                });
            ...
            modelBuilder.Entity("API.Models.Authorization.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RoleId = "4d01b5d9-6458-4258-a03d-7852ac6c43a9",
                            CreatedDate = new DateTime(2022, 1, 10, 10, 40, 56, 814, DateTimeKind.Local).AddTicks(6230)
                        });
                });
            ...
            modelBuilder.Entity("ManagerChannel.Models.Regulations.Network_Regulation", b =>
                {
                    ...
                    b.HasKey("RegulationId", "NetworkId");

                    b.HasIndex("NetworkId");

                    b.ToTable("Network_Regulations");
                });

            modelBuilder.Entity("ManagerChannel.Models.Regulations.Project_Regulation", b =>
                {
                    b.Property<string>("RegulationId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("RegulationId", "ProjectId");

                    b.HasIndex("ProjectId");

                    b.ToTable("Project_Regulations");
                });

            modelBuilder.Entity("ManagerChannel.Models.Regulations.Regulation", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ManagerChannel.Models.Regulations.Team_Regulation", b =>
                {
                    b.Property<string>("RegulationId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("RegulationId", "TeamId");

                    b.HasIndex("TeamId");

                    b.ToTable("Team_Regulations");
                });
            ...
            modelBuilder.Entity("ManagerChannel.Models.Regulations.Network_Regulation", b =>
                {
                    b.HasOne("ManagerChannel.Models.Networks.NetWork", "NetWork")
                        .WithMany("Network_Regulations")
                        .HasForeignKey("NetworkId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ManagerChannel.Models.Regulations.Regulation", "Regulation")
                        .WithMany("Network_Regulations")
            ...
            modelBuilder.Entity("ManagerChannel.Models.ManagementProject.Project", b =>
                {
                    b.Navigation("Project_Regulations");
            ...
            modelBuilder.Entity("ManagerChannel.Models.Networks.NetWork", b =>
                {
                    ...
                    b.Navigation("Network_Regulations");
